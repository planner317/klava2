let playlist = {}
playlist.text = `Dog will hunt I'm the front end loader travoltin' over so try my slam on for size
...
All you need is my Uhn Tiss Uhn Tiss Uhn Tiss`
playlist.lang="eng"
playlist.urlSound = "./music/Bloodhound Gang - Uhn Tiss Uhn Tiss.mp3";
playlist.stop=[
    {music:2.4, text: 50 },
    {music:7, text: 81 },
    {music:11, text: 138 },
...
playlist.volume = 0.7
playlist.start = 0
playlist.end = 53     // длина секунд до последей буквы текста
